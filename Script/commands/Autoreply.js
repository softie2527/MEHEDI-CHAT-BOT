...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস মেহেদীরে হাঙ্গা করো😶👻😘",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Mehedi Hassan☜\nFacebook: https://www.facebook.com/profile.php?id=100044713412032",
    "admin": "He is Mehedi  Hassan তাকে সবাই Admin Mehedi হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস মেহেদীরে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস মেহেদী এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌Muntaha Chat bot💖",
    ...
    "ki koros": "বস মেহেদী এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    "kire bot": "হ্যাঁ সব কেমন আছেন",
    "valo aso": "হ্যাঁ রে প্রিও, বস মেহেদী এর দোয়ায় ভালো আছি 😌💞",
    "pagol": "হুম পাগল, কিন্তু তোমারই পাগল 😏😂",
    "breakup": "চিন্তা করিস না… মেহেদী বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস মেহেদী এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "ami mimi": "মিমি কেমন আছো? ভাবি ডাকলে আইসক্রিম দিবো",
    "ami sharmin": "ও আকাম্মাভতী নে😳",
    "ami raisa": "তোমার মেয়েরে আমার মেহেদীর থেকে দূরে থাকতে বলবা😒",
    "Mehedi k": "মেহেদী হলো আমার জামাই আর তোমাদের দুলাভাই",
    "vabi": "এই নাও আইসক্রিম ভাবি ডাকছো যে তাই🍦🍨",
